For this activity, this is a web application that displays an event and its details. You need to apply what you have learned from the routing, rendering, data fetching and optimization.
